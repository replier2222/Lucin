...
RESOURCES += src/qt/lucin.qrc src/qt/lucin_locale.qrc

TRANSLATIONS += src/qt/locale/lucin_bg.ts \
                src/qt/locale/lucin_de.ts \
                src/qt/locale/lucin_en.ts \
                src/qt/locale/lucin_es.ts \
                src/qt/locale/lucin_fi.ts \
                src/qt/locale/lucin_fr.ts \
                src/qt/locale/lucin_it.ts \
                src/qt/locale/lucin_ja.ts \
                src/qt/locale/lucin_pl.ts \
                src/qt/locale/lucin_pt.ts \
                src/qt/locale/lucin_ru.ts \
                src/qt/locale/lucin_sk.ts \
                src/qt/locale/lucin_sv.ts \
                src/qt/locale/lucin_vi.ts \
                src/qt/locale/lucin_zh_CN.ts \
                src/qt/locale/lucin_zh_TW.ts
