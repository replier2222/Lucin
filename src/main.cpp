...
#if defined(NDEBUG)
#error "Lucin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Lucin Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 4500 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 4500 && nHeight <= 8000 ) {
	        nSubsidy = 50 * COIN;
