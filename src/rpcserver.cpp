...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LSN features */
        {"lucin", "masternode", &masternode, true, true, false},
        {"lucin", "masternodelist", &masternodelist, true, true, false},
        {"lucin", "mnbudget", &mnbudget, true, true, false},
        {"lucin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"lucin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lucin", "mnsync", &mnsync, true, true, false},
        {"lucin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"lucin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lucind, or the -server option to lucin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lucin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25022/\n";
}
