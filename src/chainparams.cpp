...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000009025f76a3814e6f17bf6aa2787db16f6d53d2f4c9ada86f5ef1490386ab"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1527845819, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 5000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Lucin cryptobirthday";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1527845819;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21808700;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000009025f76a3814e6f17bf6aa2787db16f6d53d2f4c9ada86f5ef1490386ab"));
        assert(genesis.hashMerkleRoot == uint256("0x4418af1a7bd0c5722d4466aa1fed0335e83e2b3998063f7ec1da89ccfba40783"));
        

        vSeeds.push_back(CDNSSeedData("seed1.lucin.online", "seed1.lucin.online"));
        vSeeds.push_back(CDNSSeedData("seed2.lucin.online", "seed2.lucin.online"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1527845819; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1527845820;
        genesis.nNonce = 22719506;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000000b7be0f2cf2de67c0fd9336ffed7d6bbbb54fbff45538001a9c8d1635ca"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Lucin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Lucin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Lucin BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1527845820;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1527845821;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x316f52076b47e0efbc4e0e1183cfaab1f0c470a2f66c438b8fe498c18714dfae"));
