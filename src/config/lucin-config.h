/* src/config/lucin-config.h.  Generated from lucin-config.h.in by configure.  */
/* src/config/lucin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://lucin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lucin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lucin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lucin"
